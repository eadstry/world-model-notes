...
该工作提出了 RIGVid，通过模仿生成视频而非物理演示来进行机器人操控学习。其核心创新在于：彻底跳过了物理演示数据的采集过程，直接利用世界模型/视频生成模型生成"想象中的操作视频，然后让机器人策略从这些合成视频中学习操控技能。
该工作的突破性在于它展示了零物理演中的机器人学习可能性，为大幅降低机器人技能学习的数据门槛提供了全新的范式。
## 相关笔记
